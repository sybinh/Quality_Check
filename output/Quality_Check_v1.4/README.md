...
### Version 1.4 (Aug 28, 2026)
- New: `--json` flag outputs structured JSON to stdout for scripting and automation
- New: `--output FILE.json` writes JSON report to file while keeping text output in terminal
- New: Multi-user `--output` auto-prefixes files by NTID (e.g. `DAB5HC_report.json`)
