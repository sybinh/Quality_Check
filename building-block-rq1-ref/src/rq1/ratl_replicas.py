...
class Ratl_Replicas(BaseRecord):
    
    model_config = ConfigDict(populate_by_name=True, extra="allow")
    
    clan: typing.Optional[str] = Field(alias="cq:clan", default=None)
    ...
    family: typing.Optional[str] = Field(alias="cq:family", default=None)
    
    flags: typing.Optional[int] = Field(alias="cq:flags", default=None)
    
    formatted_rev: typing.Optional[int] = Field(alias="cq:formatted_rev", default=None)
    
    host: typing.Optional[str] = Field(alias="cq:host", default=None)
    ...
    operating_rev: typing.Optional[int] = Field(alias="cq:operating_rev", default=None)
    ...
    schema_id: typing.Optional[int] = Field(alias="cq:schema_id", default=None)
    
    schema_rev: typing.Optional[int] = Field(alias="cq:schema_rev", default=None)
    
    schemarev_version: typing.Optional[int] = Field(alias="cq:schemarev_version", default=None)
    ...
    uuid: typing.Optional[str] = Field(alias="cq:uuid", default=None)
...
class Ratl_ReplicasProperty(Enum):
    clan = "cq:clan"
    ...
    family = "cq:family"
    flags = "cq:flags"
    formatted_rev = "cq:formatted_rev"
    host = "cq:host"
    ...
    name = "cq:name"
    operating_rev = "cq:operating_rev"
    ratl_keysite = "cq:ratl_keysite"
    ratl_mastership = "cq:ratl_mastership"
    rdf__type = "rdf:type"
    schema_id = "cq:schema_id"
    schema_rev = "cq:schema_rev"
    schemarev_version = "cq:schemarev_version"
...
def create_ratl_replicas_changeset(
    clan: typing.Optional[str] = None,
    ...
    formatted_rev: typing.Optional[int] = None,
    ...
    operating_rev: typing.Optional[int] = None,
    ...
    schema_id: typing.Optional[int] = None,
    schema_rev: typing.Optional[int] = None,
    schemarev_version: typing.Optional[int] = None,
    ...
    '''
    Create a Ratl_Replicas changeset.
    '''
    fields = {}
    if clan is not None:
        fields["cq:clan"] = clan 
    ...
    if family is not None:
        fields["cq:family"] = family 
    if flags is not None:
        fields["cq:flags"] = flags 
    if formatted_rev is not None:
        fields["cq:formatted_rev"] = formatted_rev 
    if host is not None:
        fields["cq:host"] = host 
    ...
    if name is not None:
        fields["cq:name"] = name 
    if operating_rev is not None:
        fields["cq:operating_rev"] = operating_rev 
    ...
    if schema_id is not None:
        fields["cq:schema_id"] = schema_id 
    if schema_rev is not None:
        fields["cq:schema_rev"] = schema_rev 
    if schemarev_version is not None:
        fields["cq:schemarev_version"] = schemarev_version 
    ...
    fields["dcterms:type"] = "ratl_replicas"
    return Ratl_Replicas(**fields)