...
class Rq1_Tldselector(BaseRecord):
    ...
    tldvalue: typing.Optional[str] = Field(alias="cq:TLDvalue", default=None)
...
class Rq1_TldselectorProperty(Enum):
    dbid = "cq:dbid"
...
def create_rq1_tldselector_changeset(
    ...
    tldvalue: typing.Optional[str] = None,
    version: typing.Optional[int] = None,
    
) -> Rq1_Tldselector:
    '''
    Create a Rq1_Tldselector changeset.
    '''
    fields = {}
    if dbid is not None:
        fields["cq:dbid"] = dbid 
    ...
    if tld is not None:
        fields["cq:TLD"] = tld 
    if tldvalue is not None:
        fields["cq:TLDvalue"] = tldvalue 
    if version is not None:
        fields["cq:version"] = version 
    

    fields["dcterms:type"] = "RQ1_TLDSelector"
    return Rq1_Tldselector(**fields)